...
; retires it: one bounded rebuild onto a fresh solver configured without
; it. AUTO retires only after trail reuse is gone (the floating-point
; content here sheds it at the first solve, for free), after enough
; solves, and past the size floor (each round here carries a distinct
