...
; CHECK: Incremental profile cbp/backend: check=1.*sat-calls=2 refinement-sat-calls=1 refinement-rounds=1
; CHECK: Incremental profile total: checks=1.*sat-calls=2 refinement-sat-calls=1 refinement-rounds=1
; CHECK: ^unsat
(check-sat)
(exit)
