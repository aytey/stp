...
;
; RUN: %solver --bv-eq-abstraction=1 --bv-eq-abstraction-width=1 %s 2>&1 | %OutputCheck --check-prefix=ABSTRACTED %s
; RUN: %solver --bv-eq-abstraction=1 --bv-eq-abstraction-width=1 --bv-term-abstraction=1 %s 2>&1 | %OutputCheck --check-prefix=ABSTRACTED %s
