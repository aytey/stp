...
; the low two bits of -x are 11. The first candidate gives s the all-zero
; value and violates ADD_ZERO, so the schema says result = -x. If it were
...
; SCHEMAS: BV abstraction: BVPLUS add-zero lemma over operand 1
; SCHEMAS: ^sat$
;
