...
; unsatisfiable. STP said otherwise, and by four routes said it four ways --
; plain "sat" under --incremental with -r, and an internal error on the other
; three, where the model evaluation and the encoding then disagreed about the
; cell:
;
...
; checker already pinned its own virtual reads.
;
; CHECK: ^unsat
(set-logic QF_ABVFP)
