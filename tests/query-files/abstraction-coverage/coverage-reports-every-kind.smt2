...
; CHECK: Abstraction schemas by group: base=[0-9]+ udiv15=0 udiv-observed=0 udiv-tail=0 urem=[0-9]+ quotient-one-quot=0 quotient-one-rem=0 quotient-thresholds=0 divisor-magnitude=0 divrem-pair=0 divrem-full=0 mul8=0 mul-ref3=[0-9]+ mul-tail=0 add=0 low-prefix=0
...
; EARLY-NOT: Abstraction escalation cost:
(check-sat)
(exit)
