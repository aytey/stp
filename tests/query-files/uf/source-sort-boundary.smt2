...
; CHECK: REACHED-END
;
; The RoundingMode row is now on the admitted side of the boundary: it is
; retained as a declaration that goes through and is applied, so that the
; sort's position here is pinned rather than merely unmentioned.
