...
| Models and APIs | `UFModel`, counterexample replay, `Cpp_interface::getUninterpretedApplicationValue`, `vc_declareUninterpretedFunction`, `vc_applyUninterpretedFunction`, `vc_getUninterpretedFunctionValue`, and Python wrappers publish only certified source-level values and deterministic total interpretations. |
